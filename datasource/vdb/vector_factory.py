...
from datasource.entity.embedding import Embeddings
from datasource.vdb.vector_base import BaseVector
from datasource.vdb.vector_type import VectorType
    ...
    def get_vector_factory(vector_type: str) -> type[AbstractVectorFactory]:
        match vector_type:
            ...
            case VectorType.MILVUS:
                from datasource.vdb.milvus.milvus_vector import MilvusVectorFactory
                return MilvusVectorFactory
            case VectorType.MYSCALE:
                from datasource.vdb.myscale.myscale_vector import MyScaleVectorFactory
                return MyScaleVectorFactory
            case VectorType.PGVECTOR:
                from datasource.vdb.pgvector.pgvector import PGVectorFactory
                return PGVectorFactory
            case VectorType.PGVECTO_RS:
                from datasource.vdb.pgvecto_rs.pgvecto_rs import PGVectoRSFactory
            ...
            case VectorType.RELYT:
                from datasource.vdb.relyt.relyt_vector import RelytVectorFactory
                return RelytVectorFactory
            case VectorType.TIDB_VECTOR:
                from datasource.vdb.tidb_vector.tidb_vector import TiDBVectorFactory
                return TiDBVectorFactory
            case VectorType.WEAVIATE:
                from datasource.vdb.weaviate.weaviate_vector import WeaviateVectorFactory
                return WeaviateVectorFactory
            case VectorType.TENCENT:
                from datasource.vdb.tencent.tencent_vector import TencentVectorFactory
                return TencentVectorFactory
            case VectorType.ORACLE:
                from datasource.vdb.oracle.oraclevector import OracleVectorFactory
                return OracleVectorFactory
            case VectorType.OPENSEARCH:
                from datasource.vdb.opensearch.opensearch_vector import OpenSearchVectorFactory
                return OpenSearchVectorFactory
            case VectorType.ANALYTICDB:
                from datasource.vdb.analyticdb.analyticdb_vector import AnalyticdbVectorFactory
